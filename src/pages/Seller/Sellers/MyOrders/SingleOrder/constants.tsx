...
import {ProductStatusColor, ProductStatusText} from '@/api/types';
...
import {PrePaymentAction} from './OrderPayments/PrePaymentModalAction';
import {OrderProducts} from './OrderProducts';
import {OrderProductsAction} from './OrderProducts/OrderProductsAction';
...
export const orderProductsColumns: ColumnType<ISaleOrderProduct>[] = [
  ...
  },
  {
    ...
    title: 'Действия',
    align: 'center',
    render: (value, record) => <OrderProductsAction product={record} />,
  },
];
...
export const productSalePaymentsColumns: ColumnType<ISellerProductSalePayments>[] = [
  ...
  },
  {
    ...
    dataIndex: 'action',
    align: 'center',
    render: (value, record) => <PrePaymentAction payment={record} />,
  },
];
